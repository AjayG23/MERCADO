...
$page_title = "MERCADO | Processed Orders";
        ...
        <div class="container">
            <div class="row">
                ...
                <table class="table">        
                    <tbody>
                <?php
                $sql = "SELECT * FROM orders WHERE seller_id='$user_id' AND order_status = 'A'";
                ...
                if(mysqli_num_rows($result)>0){
                    while($row = mysqli_fetch_assoc($result))
                    {
                        ...
                        $dispatched_date_time = date('d/m/Y', $row["dispatched_date_time"]);
                        ...
                        <tr class="cart-item-<?php echo $product_id;?>">
                            ...
                            <td class="cart-product-name">
                                ...
                                <p>Processed Order Date <?php echo $dispatched_date_time;?></p>
